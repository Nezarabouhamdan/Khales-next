...
export const services: Service[] = [
  {
    ...
    cover: "https://i.ibb.co/FL5BsmnZ/BAN-360.png",
    gallery: [
      "https://i.ibb.co/FL5BsmnZ/BAN-360.png",
    ...
    titleAr: "إدارة المشاريع الشاملة (360°)",
    description:
    ...
    keyFeaturesAr: [
      "إعداد المشروع والموجز الأولي",
      "تنسيق التصميم",
      "الموافقات والتصاريح",
      "المشتريات واختيار المقاولين",
      "إدارة البناء",
      "التسليم النهائي",
    ],
    process: [
    ...
    processAr: [
      {
        title: "إعداد المشروع والموجز الأولي",
        description:
          "نبدأ بفهم أهدافك وظروف الموقع وتوقعاتك، ثم نبني استراتيجية تسليم تتناسب مع جدولك الزمني وميزانيتك.",
      },
      {
        title: "تنسيق التصميم",
        description:
          "ندير المهندسين المعماريين والهندسيين والاستشاريين لضمان توافق عملية التصميم وكفاءتها وسلامتها الفنية.",
      },
      {
        title: "الموافقات والتصاريح",
        description:
          "نُعد ونُقدّم جميع المستندات اللازمة إلى الجهات الحكومية المحلية، ونتابع الامتثال والمتابعات.",
      },
      {
        title: "المشتريات واختيار المقاولين",
        description:
          "نحدد المقاولين المؤهلين، ونقيّم العروض، ونتفاوض على أفضل الخيارات لتحقيق التوازن بين التكلفة والجودة.",
      },
      {
        title: "إدارة البناء",
        description:
          "نراقب أعمال الموقع يوميًا، ونراجع التقدم، ونحل النزاعات، ونتأكد من الالتزام بالجداول الزمنية والمواصفات.",
      },
      {
        title: "التسليم النهائي",
        description:
          "نضمن إنجاز المشروع بشكل صحيح — مع فحوصات الجودة والتوثيق والتسليم السلس للعميل.",
      },
    ],
    faqs: [
      {
      ...
      {
        question: "Will I still be involved in decisions?",
        answer:
    ...
    faqsAr: [
      {
        question:
          "ما الفرق بين إدارة المشاريع الشاملة (360) وتوظيف مقاول مباشرة؟",
        answer:
          "مع إدارة المشاريع الشاملة (360)، أنت لا توظف بنّاءً فقط — بل تعيّن فريقًا محترفًا لتخطيط كل خطوة من مشروعك والإشراف عليها والتحكم بها. نحن ننسق بين جميع الأطراف، ولا نكتفي بتنفيذ البناء فقط.",
      },
      {
        question: "هل سأظل مشاركًا في القرارات؟",
        answer:
          "نعم. تبقى أنت صاحب القرار، ونزودك بتحديثات وتوصيات منظمة لتتمكن من اتخاذ قرارات مستنيرة دون التعامل مع ضغوط المشروع اليومية.",
      },
      {
        question: "هل يشمل ذلك موافقات الجهات الحكومية؟",
        answer:
          "نعم. نتولى جميع عمليات الموافقة — المخططات، والتصاريح، والتفتيش، والتقديمات — كجزء من نطاق الخدمة الكاملة.",
      },
      {
        question: "ما هي أنواع المشاريع الأنسب لهذه الخدمة؟",
        answer:
          "تُعد إدارة المشاريع الشاملة (360) مثالية للفلل الخاصة، والمساكن الفاخرة، والعقارات التجارية، أو أي مشروع يتطلب تنسيقًا ومساءلة واضحين عبر جميع المراحل.",
      },
    ],
    metaTitle: "360 Project Management Services in Dubai | Khales Group",
    metaTitleAr: "إدارة المشاريع 360 درجة في دبي | مجموعة خالص",
    metaDescription:
