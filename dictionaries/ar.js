...
export const dictionary = {
  ...
  personalShoppingPage: {
      ...
      items: [
        {
          ...
          text:
            "تحصل على دخول حصري إلى كتالوجات التجارية الحصرية والعلامات الفاخرة الدولية والحرفيين النخبة المغلقة أمام عامة الناس.",
        },
        {
          title: "توفير الوقت وراحة البال",
          text:
            "وقتك هو أثمن مالك. نحن نخلصك من إرهاق التصفح اللانهائي في صالات العرض، ومفاوضات الموردين، وتأخيرات الشحن، وتتبع اللوجستيات.",
        },
        {
          title: "سلامة التصميم وحماية القيمة الاستثمارية",
          text:
            "يتم فحص كل قطعة بدقة مقارنة بتخطيط الفيلا، وظروف الإضاءة، والنسب المعمارية — مما يمنع أخطاء القياس المكلفة أو عدم توافق التصميم.",
        },
      ],
    },
    sourcingJourney: {
    ...
    faq: {
      ...
      questions: [
        {
          title: "هل تقومون بتوريد قطع من الكتالوجات الحصرية أو المغلقة أمام العامة؟",
          content:
