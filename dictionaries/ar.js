  ...
  blogsPage: {
    ...
    posts: [
      ...
      },
      {
        ...
        tags: ["تصميم", "داخلي"],
        title:
          "أناقة خالدة: فك تشفير التصميم الداخلي الكلاسيكي مقابل النيوكلاسيكي",
        description:
          "اكتشف الفروق الأساسية بين التصميم الداخلي الكلاسيكي والنيوكلاسيكي — من البذخ الزخرفي إلى التوازن الهندسي — واختر الأسلوب الذي يناسب رؤيتك.",
        postMeta: {
          title:
            "أناقة خالدة: فك تشفير التصميم الداخلي الكلاسيكي مقابل النيوكلاسيكي | خالص",
          description:
        ...
        fullContent: {
          subtitle: "دليل للتعرف على الفروق الرقيقة بين أسلوبين داخليين خالدين",
          paragraphs: [
            "إذا تصفحت يومًا مجلة معمارية أو تجولت في منزل تاريخي، فمن المحتمل أنك أعجبت بالتصميم الكلاسيكي والنيوكلاسيكي معًا. نظرًا لأن كلا الأسلوبين متجذران في التاريخ ويعتمدان بشكل كبير على الأناقة، غالبًا ما تُستخدم المصطلحات بالتبادل. ومع ذلك، فإن عين المصمم ترى أن لكلٍ منهما عصره وفلسفته الخاصة في التعامل مع المساحة.",
            "سواء كنت تبحث عن تجديد منزلك أو ترغب فقط في تحديث معرفتك بتاريخ التصميم، فإن فهم الفرق بين هذين الأسلوبين الأيقونيين يعود إلى صراع بين البذخ الزخرفي والتقيد المتناغم.",
          ],
          quote:
            "إذا شعرت وكأنك في قصر فرنسي من القرن السابع عشر، فأنت أمام تصميم كلاسيكي؛ أما إذا بدا المكان كتحية متزنة لمعبد يوناني، فأنت أمام النيوكلاسيكي.",
          paragraphAfterQuote:
            "فيما يلي تفصيل لما يميز كل أسلوب، من الأشكال والألوان إلى الأقمشة والزخارف.",
          socialCounts: [5000, 37, 60000, 24000],
          sectionTitle: "الكلاسيكي مقابل النيوكلاسيكي: ما الفرق بينهما؟",
          thirdParagraph:
            "يتميز التصميم الكلاسيكي بالتفاصيل المزخرفة، والألوان الغنية، والأثاث الضخم. بينما يسعى التصميم النيوكلاسيكي إلى الانسجام من خلال النسب، ولوحات ألوان أخف، وإشارات أنيقة إلى الحضارة القديمة.",
          listItems: [
            "الكلاسيكي: زخرفة ثقيلة، ألوان جواهرية عميقة، وأثاث من الخشب المنحوت.",
            "النيوكلاسيكي: تناظر، لوحات ألوان هادئة، وزخارف كلاسيكية مثل المفاتيح اليونانية والأعمدة.",
            "الكلاسيكي: أقمشة فاخرة مثل المخمل والبروديه تضيف عمقًا ودفئًا.",
            "النيوكلاسيكي: الكتان الحريري والأقمشة الخفيفة تمنح إحساسًا بهواء متوازن.",
          ],
          fourthParagraph:
            "في النهاية، يقدم كلا الأسلوبين أناقة خالدة — أحدهما عبر التراكم الفخم والحرفية، والآخر عبر النظام الدقيق والضبط الكلاسيكي. اختر النهج الذي يتناغم مع ذوقك، أو امزج بينهما لبيان فريد يعكس شخصيتك.",
        },
      },
    ],
  },
