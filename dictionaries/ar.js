...
export const dictionary = {
    ...
    items: [
      {
        ...
        highlight: "إرث",
        description:
          "نشكّل آفاق المدن بمبانينا السكنية الشاهقة، ونصنع إرثاً للأجيال بقصورنا الحصرية، ونصمم ملاذات هادئة بفلل فاخرة ومصممة خصيصًا. رؤيتك، مبنية لتدوم.",
      ...
      },
      {
        ...
        highlight: "وجهات",
        description:
          "نبني أركان المجتمع: من مراكز التسوق النابضة بالحياة والمستشفيات الحديثة، إلى المدارس والجامعات الملهمة التي يتشكل فيها المستقبل.",
  ...
  residentialPage: {
    meta: {
      title: "تصميم معماري سكني: مباني، قصور، وفلل | خالص",
      description:
        "من المباني السكنية الشاهقة التي تعيد تعريف الأفق، إلى القصور الحصرية والفلل الهادئة، اكتشف محفظتنا من مساحات المعيشة الفاخرة المصممة خصيصًا لك.",
    },
    header: {
      tag: "هندسة معمارية سكنية تليق بإرثك",
      title: "من الأفق الشاهق إلى الملاذ الخاص",
      year: "٢٠٢٠-٢٠٢٤",
    ...
    overview: {
      title: "نصنع عالمك، بكل المقاييس",
      text: [
        "تبدأ رؤيتنا من الأفق نفسه، حيث نصمم **المباني السكنية** الأيقونية التي تصبح معالم للمدينة، موفرةً أسلوب حياة لا مثيل له. نحن ندمج الهندسة المبتكرة مع الجماليات الخالدة لخلق مجتمعات عمودية فريدة.",
        "يمتد هذا الالتزام بالتميز إلى إنشاء **القصور** الشاسعة التي تروي قصة إرث عائلي، ويكتمل في أدق تفاصيل **الفلل** الفاخرة التي نصممها لتكون ملاذك الخاص والآمن.",
      ],
      tag: "مباني | قصور | فلل",
      image:
    ...
    challenges: {
      ...
      text: "براعتنا تكمن في قدرتنا على التكيف مع مختلف المقاييس، من المتطلبات الهيكلية المعقدة للمباني الشاهقة إلى اللمسات النهائية شديدة الخصوصية في الفلل والقصور.",
      solutions: [
        "هندسة إنشائية متقدمة للمباني السكنية العالية.",
        "مصادر حصرية للمواد الفاخرة للقصور والفلل.",
        "تصميم يراعي الخصوصية المطلقة مع دمج الطبيعة.",
      ],
      image:
  ...
  commercialPage: {
    meta: {
      title: "إدارة المشاريع وإعادة الابتكار التجاري | خالص",
      description:
        "نحن متخصصون في إعادة ابتكار المشاريع التجارية من خلال إدارة المشاريع الاحترافية. نقوم بتحويل وتقديم المشاريع التجارية، من المراكز التجارية إلى المستشفيات، في الوقت المحدد وضمن الميزانية.",
    },
    header: {
      tag: "إعادة ابتكار المشاريع التجارية وإدارتها",
      title: "نحوّل الأصول، ونعظّم القيمة",
      year: "٢٠١٨-٢٠٢٤",
      location: "دبي، أبوظبي",
      services: "إدارة مشاريع متكاملة",
      bgImage:
    ...
    overview: {
      ...
      text: [
        "نحن لا نبني مساحات تجارية فحسب، بل نمارس **إعادة الابتكار التجاري**. هذا يعني بث حياة جديدة في الأصول القائمة أو إنشاء مشاريع جديدة برؤية مستقبلية، مع التركيز على تعظيم القيمة وضمان الاستدامة طويلة الأمد.",
        "يتم تحقيق ذلك من خلال **إدارة المشاريع** الصارمة. يوفر فريقنا إشرافًا كاملاً من دراسة الجدوى الأولية وحتى التسليم النهائي، مما يضمن تنفيذ كل جانب من جوانب المشروع بدقة وكفاءة.",
      ],
    ...
    challenges: {
      title: "إتقان التعقيد من خلال إدارة المشاريع",
      text: "المشاريع التجارية الكبرى تتطلب أكثر من مجرد بناء. إنها تتطلب **إدارة مشاريع** استراتيجية للتعامل مع المتطلبات التنظيمية والمالية المعقدة، وهذا هو صميم خبرتنا.",
      solutions: [
        "**إدارة مشاريع** استراتيجية لمبادرات **إعادة الابتكار التجاري** المعقدة.",
        "تخطيط مالي دقيق طوال دورة حياة المشروع لضمان الجدوى والعائد على الاستثمار.",
        "منهجيات عمل مرنة للتكيف مع متطلبات السوق المتغيرة أثناء التطوير.",
      ],
      image:
