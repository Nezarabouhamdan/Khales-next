...
export const dictionary = {
    ...
    posts: [
      ...
      },
      {
        ...
        fullContent: {
          ...
          socialCounts: [5000, 37, 60000, 24000], // فيسبوك، تويتر، انستغرام، لينكدإن
          paragraphs: [
  ...
  readyDesignsPage: {
    metaTitle: "Ready-to-Execute Architectural Designs | Khales",
    metaDescription:
      "Discover an exclusive collection of ready-made architectural and interior designs.",
    hero: {
      titleLine1: "Architectural Designs",
      titleLine2: "Ready to Execute",
      description:
        "Discover an exclusive collection of meticulously crafted architectural and interior designs. Save time and cost with professional ready-to-execute designs.",
      stats: [
      ...
      steps: [
        {
          ...
          desc: "Explore our diverse collection of designs and use filters to find the perfect one.",
        },
        {
          num: "02",
          title: "Choose Design",
          desc: "View design details, floor plans, and 3D renders before making your decision.",
        },
        {
          num: "03",
          title: "Complete Purchase",
          desc: "Own your design now with the click of a button.",
        },
        {
          num: "04",
          title: "Receive Files",
          desc: "Get all digital design files instantly and start execution.",
        },
      ],
    },
    gallery: {
      topLabel: "Design Gallery",
      title1: "Discover Our",
      title2: "Exclusive",
      title3: "Designs",
      filters: [
      ...
      designs: [
        {
          id: 1,
          title: "Executive Villa Interior Design",
          desc: "Ultra-luxury interior design combining dark wood, smart lighting, and contemporary architectural elements.",
          price: "5,000",
          currency: "AED",
          category: "interior",
          area: "450 m²",
        ...
        {
          id: 2,
          title: "Contemporary Grand Majlis",
          desc: "Massive reception area blending modern stone textures with traditional hospitality layout, open design, and double-height ceiling.",
          price: "7,500",
          currency: "AED",
          category: "interior",
          area: "85 m²",
        ...
        {
          id: 3,
          title: "Organic Khawaneej Villa",
          desc: "Luxury organic villa blending stone arches and flowing interior spaces, with panoramic views and Abu Dhabi natural flair.",
          price: "15,000",
          currency: "AED",
          category: "villas",
          area: "1,200 m²",
      ...
      orderBtn: "Order Design",
    },
    pricing: {
      title1: "Choose Your",
      title2: "Perfect",
      title3: "Package",
      desc: "Three pricing tiers carefully designed to suit all needs and budgets, ensuring the highest quality standards.",
      currency: "AED",
      selectPlan: "Select Package",
      note: "All prices are in AED. Any design can be customized to your requirements at an additional cost.",
      packages: [
        {
          id: "basic",
          name: "Basic",
          tier: "Bronze",
          price: "2,000",
          desc: "Basic design with architectural plans and basic 3D visualization.",
          features: [
            "Architectural Plans",
            "Basic 3D Renders",
            "Material Board",
        ...
        },
        {
          ...
          tier: "Gold",
          price: "5,000",
          desc: "Full design with detailed architectural plans, 3D renders, and material specifications.",
          features: [
        ...
        },
        {
          ...
          tier: "Platinum",
          price: "15,000",
          desc: "Custom luxury design with full architectural documentation, VR tour, and consultation.",
          features: [
    ...
    aiBanner: {
      badge: "Powered by AI",
      title1: "Customize Designs",
      title2: "With a Magic Touch",
      desc: "We use the latest AI technologies to customize ready-made designs to your taste. Choose a base design and we will tweak it to fit your needs accurately and quickly.",
      cta: "Start Customizing Now",
      features: [
        { label: "Smart Space Analysis" },
        { label: "Material & Color Suggestions" },
        { label: "Instant Modifications" },
      ],
    },
    features: {
      badge: "Why Our Ready Designs",
      title1: "Irresistible",
      title2: "Features",
      desc: "Our ready-made designs combine high quality and affordability with ease of execution",
      items: [
        {
          title: "Save Time",
          desc: "Designs ready to execute immediately instead of waiting months for custom design. Start your project today.",
        },
        {
          title: "Save Cost",
          desc: "Save up to 70% compared to custom design while maintaining the highest standards of quality and professionalism.",
        },
        {
          title: "Customizable",
          desc: "Every design is editable and customizable to your specific needs at a small additional cost.",
        },
        {
          title: "Guaranteed Quality",
          desc: "Designs from the professional Khales team with over a decade of experience in architectural and interior design.",
        },
        {
          title: "Continuous Support",
          desc: "A dedicated support team to help you choose the right design and answer all your inquiries.",
        },
        {
          title: "Instant Delivery",
          desc: "Receive digital design files instantly upon purchase. Available to all Gulf countries.",
        },
      ],
    },
    testimonials: {
      ...
      reviews: [
        {
          ...
          text: "I bought a ready villa design from Khales and saved over 60% of the custom design cost. Excellent quality and the team helped with minor tweaks.",
          rating: 5,
        },
        {
          name: "Fatima Al Ali",
          role: "Interior Designer - Abu Dhabi",
          text: "As an interior designer, I use Khales' ready designs as a starting point for my projects. Details and specs are very accurate and save me a lot of time.",
          rating: 5,
        },
        {
          name: "Abdullah Al Qahtani",
          role: "Real Estate Developer - Riyadh",
          text: "We use Khales' ready designs for our residential projects in Riyadh. Prices are reasonable and designs perfectly suit the Gulf taste.",
          rating: 5,
        },
      ],
    },
    gulf: {
      badge: "Gulf Markets",
      title: "Serving All Gulf Countries",
      desc: "Our ready designs are available to all GCC countries. With the growing demand for luxury villas in the region, we provide design solutions tailored to the refined Gulf taste.",
      stats: [
        { val: "85%", label: "Annual Demand Growth" },
        { val: "+2,000", label: "Potential Clients Monthly" },
      ...
      countries: [
        {
          code: "AE",
          name: "UAE",
          desc: "Headquartered in Dubai serving all emirates.",
        },
        {
          code: "SA",
          name: "Saudi Arabia",
          desc: "Growing demand for luxury villa designs in Riyadh and Jeddah.",
        },
        {
          code: "QA",
          name: "Qatar",
          desc: "A growing market for high-end architectural designs in Doha.",
        },
        {
          code: "OM",
          name: "Oman",
          desc: "Promising opportunities in Muscat and prime tourist areas.",
        },
        {
          code: "KW",
          name: "Kuwait",
          desc: "Modern and innovative designs meeting refined Kuwaiti tastes.",
        },
        {
          code: "BH",
          name: "Bahrain",
          desc: "Smart architectural solutions fitting luxury and spaces in Manama.",
        },
      ],
    },
    cta: {
      ...
      title2: "vision",
      title3: "into reality?",
      desc: "Contact us now for a free consultation or to purchase any design from our exclusive collection. Our team is ready to help you choose the perfect design.",
      btnPrimary: "Contact via WhatsApp",
      btnSecondary: "Book Free Consultation",
    },
    showcase: {
      subtitle: "Featured Designs",
      title1: "Editors'",
      title2: "Picks",
      viewAll: "View All",
      currency: "AED",
      card1: { badge: "Residential", title: "The Opulent Neoclassical Wing" },
      card2: { badge: "Complete", title: "Contemporary Grand Majlis" },
      mainCard: {
        badge: "Luxury",
        title: "Organic Khawaneej Villa",
        desc: "Massive villa design blending large stone arches with flowing modern organic architecture. 6 bedrooms with stunning panoramic views.",
        btn: "Order Design Now",
      },
    },
    designDetails: {
      breadcrumbHome: "Home",
      breadcrumbGallery: "Ready Designs",
      specsTitle: "Project Specifications",
      areaLabel: "Total Area",
      roomsLabel: "Bedrooms",
      floorsLabel: "Floors",
      includedTitle: "Included Files",
      includedFiles: [
        "Complete Architectural Plans (AutoCAD)",
