...
export const dictionary = {
  ...
  engineeringDesignPage: {
    ...
    // Note: The ProjectHighlight data is not used in the original component, so it's omitted for now.
    // If you add it back, it should be placed here.
  },
  ...
  // ... (all your existing dictionary objects like navigation, hero, about, etc.)
  ...
  contactPage: {
    ...
    info: {
      ...
      customer: { title: "24/7 Customer Service", phone: "+971 55 129 9880" },
      hours: {
        title: "Working Hours",
  ...
  aboutUsPage: {
    ...
    // You can add content for SuccessStory and MeetTheTeam here later
  }, // ... (inside the export const dictionary = { ... })

  blogsPage: {
    // For the main /blogs listing page
    ...
    followUs: "Follow Us",
    // All blog posts are now stored here
    posts: [
      {
        id: 1,
  ...
  servicesPage: {
    // Metadata for the two category pages
    "project-management": {
