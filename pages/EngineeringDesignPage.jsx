// components/ServicePages/EngineeringDesignPage.js
"use client";
...
export default function EngineeringDesignPage({ lang, content, ctaContent }) {
  ...
  return (
    <>
      ...
      <Column>
        ...
        {/* The project highlight section was commented out in your original code, so I have kept it that way */}
