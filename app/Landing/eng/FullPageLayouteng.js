...
//================================================================
// 1. DATA FOR THE ENTIRE PAGE (Translated to English)
//================================================================
const heroNavLinks = {
...
const budgets = ["Less than 1.5M AED", "1.5M - 2.5M AED", "More than 2.5M AED"];
...
//================================================================
// 2. STYLED-COMPONENTS (Adjusted for LTR)
//================================================================
...
const NavLinksDesktop = styled.nav`
  ...
  a {
    ...
    &::after {
      ...
      position: absolute;
      bottom: 0;
      left: 0; /* CHANGED: from right: 50% */
      width: 100%;
      height: 1px;
      background: white;
      transform: scaleX(0);
      transform-origin: left; /* CHANGED: from center */
...
const CloseIcon = styled(HamburgerIcon)`
  position: absolute;
  top: 1.5rem;
  right: 2rem; /* Standard LTR position */
`;
...
const FullPageLayouteng = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePhone(formData.phone)) {
      tempErrors.phone =
        "Please enter a valid UAE phone number (e.g., 05XXXXXXXX)";
    }
    if (!formData.emirate) {
      tempErrors.emirate = "Please select an emirate";
    }
    if (!formData.budget) {
  ...
  return (
    // REMOVED: className from div to stop using Arabic font
    <div>
          ...
          >
            <ServiceBlock>
              <TextColumn variants={itemVariants}>
                ...
                <SectionSubtitle>
                  With Khales, your project is in safe hands.
                </SectionSubtitle>
              </TextColumn>
              <TextColumn variants={itemVariants}>
                <Paragraph>
                  At Khales, we manage the entire process to give you peace of
                  mind. We handle all stages, from initial approvals and
                  procedures to daily supervision and on-time delivery. Our
                  mission is to ensure the workflow is seamless, without any
                  hassle on your part.
                </Paragraph>
          ...
          >
            <ServiceBlock>
              <TextColumn variants={itemVariants}>
                ...
                <Paragraph>
                  Our team of engineers prepares precise, integrated plans that
                  comply with site requirements, conducting a comprehensive
                  review of every detail to ensure safety, efficiency, and
        ...
        <ContentContainer>
          ...
          >
            <InteriorSectionHeader variants={itemVariants}>
              <SectionTitle>Interior Design</SectionTitle>
              <Paragraph style={{ margin: "0 auto 1.5rem auto" }}>
                We create unique interior designs that reflect your refined
                taste and meet your daily needs. We translate your vision into a
                tangible reality, creating spaces that combine elegance and
                functionality to turn your home into a comfortable and vibrant
                sanctuary.
              </Paragraph>
              <ConsultButton onClick={() => scrollToSection("register")}>
                Start Your Design
          ...
          >
            <ServiceBlock>
              <TextColumn variants={itemVariants}>
                ...
                <Paragraph>
                  We create unique outdoor spaces where nature meets art. We
                  design gardens and landscapes that are an extension of your
                  home and lifestyle, focusing on creating a perfect balance
                  between visual beauty and practical comfort, making the best
                  use of the local climate and environment.
                </Paragraph>
                <ConsultButton onClick={() => scrollToSection("register")}>
                  Start Your Design
                </ConsultButton>
              ...
              <Form onSubmit={handleSubmit} noValidate>
                ...
                <FormGroup>
                  ...
                  >
                    ...
                    >
                      {formData.emirate ||
                        "In which emirate is your land plot?"}
                    </FormInput>
                    <AnimatePresence>
                      {emirateOpen && (
                        <DropdownMenu
                ...
                <FormGroup>
                  ...
                  >
                    ...
                    >
                      {formData.budget || "Expected Construction Budget"}
                    </FormInput>
                    <AnimatePresence>
                      {budgetOpen && (
                        <DropdownMenu
...
export default FullPageLayouteng;
