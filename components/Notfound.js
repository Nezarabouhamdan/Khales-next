...
const IconWrapper = styled.div`
  ...
  // Apply animation only if the icon should spin
  ${(props) => props.spin && `animation: ${rotate} 12s linear infinite;`}
`;
