...
export const projectsData = [
  ...
  },
  {
    ...
    ar: {
      tags: ["تصميم معماري", "إشراف على الموقع", "تصميم داخلي"],
      title: "منتجع السويدي",
  ...
  },
  {
    ...
    ar: {
      tags: ["تصميم معماري", "إشراف على الموقع", "نيوكلاسيك"],
      title: "فيلا مرباح",
      address: "مرباح، الإمارات العربية المتحدة",
      description:
        "فيلا نيوكلاسيكية من طابقين بواجهة متناظرة فخمة ونافورة مدخل ملكية وتصميم داخلي عصري راقٍ — في مرحلة البناء حالياً.",
      longDescription:
  ...
  },
  {
    ...
    en: {
      ...
      address: "UAE",
      description:
        "Render vs. progress: a contemporary villa featuring a geometric gold entrance, double-height lobby, and skylit spaces.",
      longDescription:
    ...
    ar: {
      tags: ["تصميم معماري", "تصميم داخلي", "تحت الإنشاء"],
      title: "فيلا الخزيمي",
      address: "الإمارات العربية المتحدة",
      description:
        "تصور مقابل التنفيذ: فيلا فاخرة تضم مدخلاً ذهبياً هندسياً، وردهة مزدوجة الارتفاع، ومساحات مضيئة بالضوء الطبيعي.",
      longDescription:
  ...
  },
  {
    ...
    en: {
      ...
      address: "UAE",
      description:
        "A waterfront villa defined by a sculptural glass chandelier lobby, open-plan live station, and refined natural material palette.",
      longDescription:
    ...
    ar: {
      tags: ["تصميم داخلي", "فيلا فاخرة", "مكتمل"],
      title: "فيلا إيلين",
      address: "الإمارات العربية المتحدة",
      description:
        "فيلا على الواجهة المائية تتميز بردهة ثريا زجاجية منحوتة، ومحطة معيشة مفتوحة، وباليت مواد طبيعية راقٍ.",
      longDescription:
  ...
  },
  {
    ...
    en: {
      ...
      address: "UAE",
      description:
        "A villa where a wave-textured master suite, split-level living hall, and sculptural marble wash areas define a refined modern interior.",
      longDescription:
    ...
    ar: {
      tags: ["تصميم داخلي", "تصميم معماري", "تحت الإنشاء"],
      title: "فيلا النهضة",
      address: "الإمارات العربية المتحدة",
      description:
        "فيلا تتميز بغرفة نوم رئيسية بجدار موجي، وقاعة معيشة ذات مستويين، ومناطق غسيل بأحواض رخامية منحوتة.",
      longDescription:
  ...
  },
  {
    ...
    en: {
      ...
      address: "Mirbah, UAE",
      description:
        "Before & after: a grand neoclassical palace with a circular columned portico, diamond-carved stone facade, and sweeping marble interior.",
      longDescription:
    ...
    ar: {
      tags: ["تصميم معماري", "إشراف على الموقع", "مكتمل حديثاً"],
      title: "مرباح برايم",
      address: "مرباح، الإمارات العربية المتحدة",
      description:
        "قبل وبعد: قصر نيوكلاسيكي فخم بأروقة أعمدة دائرية وواجهة حجرية بنقش ماسي وداخل رخامي فسيح.",
      longDescription:
  ...
  },
  {
    ...
    en: {
      ...
      address: "UAE",
      description:
        "A contemporary villa featuring a mashrabiya-screened facade, cantilevered stone volume, and a sunken courtyard with fire pit and bowl fountains.",
      longDescription:
    ...
    ar: {
      tags: ["تصميم معماري", "إشراف على الموقع", "تحت الإنشاء"],
      title: "فيلا الكندي",
      address: "الإمارات العربية المتحدة",
      description:
        "فيلا معاصرة بواجهة مشربية هندسية وحجم حجري معلق وفناء غائر بمدفأة مركزية ونوافير أحواض.",
      longDescription:
  ...
  },
  {
    ...
    en: {
      ...
      address: "UAE",
      description:
        "A mountain-view villa with diamond stone facade inserts, two-tone stone cladding, floor-to-ceiling glazing, and herringbone wood interiors.",
      longDescription:
    ...
    ar: {
      ...
      address: "الإمارات العربية المتحدة",
      description:
        "فيلا بإطلالات جبلية تتميز بواجهة حجرية ثنائية اللون بنقوش ماسية وكسوة زجاجية من الأرضية للسقف وأرضيات خشبية بنمط هيرينغبون.",
      longDescription:
